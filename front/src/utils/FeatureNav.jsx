export const FeatureNav = ({
  ...
  const setAnalysis = (e) => {
    setActiveAnalysis(e.target.closest("li").dataset.analysis);
    setSheetWidth("0px");
  };
  return (
    <aside className="nav-list bg-amber-50 p-1 py-10 text-[10px] w-20">
      ...
      <ul className="flex flex-col gap-3 ">
        <li
          className="flex justify-center flex-col items-center gap-1 cursor-pointer hover:bg-amber-200 px-1 pb-1 text-amber-800 hover:text-amber-800"
          data-analysis="Descriptives"
          //   onClick={() => setActiveAnalysis("Descriptives")}
          onClick={setAnalysis}
        >
